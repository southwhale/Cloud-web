;(function (window, undefined) {
    ...
    var calendar = document.querySelector('#CloudCalendar');
    ...
    // tab切换
    function renderTab() {
        var aTab = calendar.querySelector('.CloudCalendarHeader').querySelectorAll('li')
    ...
    function initalToday() {
        ...
        fullMonth_lunar.innerHTML = '<i></i>' + ChineseCalendar.year2GanZhe(year) + ChineseCalendar.getAnimal(year) + '年';
        renderFullMonth();
    ...
    function dateEvent() {
        var control = calendar.querySelector('#CloudCalendarControl')
        ...
        var popup = calendar.querySelector('#CloudCalendarPopup')
